...
export const weddingConfig = {
  ...
  photos: {
    groom: [
      { src: "/Wedding Photos/Groom's Solo Photos5.jpg", alt: "新郎张波" },
      { src: "/Wedding Photos/Groom's Solo Photos7.jpg", alt: "新郎张波" },
      { src: "/Wedding Photos/Groom's Solo Photos8.jpg", alt: "新郎张波" },
      { src: "/Wedding Photos/Groom's Solo Photos9.jpg", alt: "新郎张波" },
      { src: "/Wedding Photos/Groom's Solo Photos10.jpg", alt: "新郎张波" },
    ],
    bride: [
      { src: "/Wedding Photos/Bride's Solo Photos5.jpg", alt: "新娘邓芮" },
      { src: "/Wedding Photos/Bride's Solo Photos6.jpg", alt: "新娘邓芮" },
      { src: "/Wedding Photos/Bride's Solo Photos7.jpg", alt: "新娘邓芮" },
    ],
    son: [
      { src: "/Wedding Photos/Son's Photos5.jpg", alt: "宝贝" },
      { src: "/Wedding Photos/Son's Photos6.jpg", alt: "宝贝" },
      { src: "/Wedding Photos/Son's Photos7.jpg", alt: "宝贝" },
      { src: "/Wedding Photos/Son's Photos8.jpg", alt: "宝贝" },
      { src: "/Wedding Photos/Son's Photos9.jpg", alt: "宝贝" },
      { src: "/Wedding Photos/Son's Photos10.jpg", alt: "宝贝" },
      { src: "/Wedding Photos/Son's Photos11.jpg", alt: "宝贝" },
    ],
    document: [{ src: "/Wedding Photos/Wedding Document Photo.jpg", alt: "结婚证照" }],
  },
  ...
  gallery: [
    ...
    { id: 7, src: "/Wedding Photos/Son's Photos6.jpg", title: "小天使", description: "满满的爱", category: "family" },
    {
      id: 8,
